...
- `FILE_NAME`: your json file with class details
...
```
docker run --rm -v ./data:/app/data -e GESAC_LOGIN=your-email@example.com -e GESAC_PASSWORD=your-password -e FILE_NAME=daysTim.json --name gsac_booker gsac
```
